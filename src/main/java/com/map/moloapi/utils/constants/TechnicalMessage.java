...
public class TechnicalMessage {
    ...
    public static final String ACCOUNT_DISABLE = "Votre compte est desactivé, veuillez contactez un super-administrateur.";
    public static final String PASSWORD_EXPIRED = "Votre mot de passe a expiré";
    public static final int PASSWORD_GENERATED_LENGTH = 6;
    public static final String TZ_START_SUFFIX = "T00:00:00Z";
    public static final String TZ_END_SUFFIX = "T23:59:59Z";
}
